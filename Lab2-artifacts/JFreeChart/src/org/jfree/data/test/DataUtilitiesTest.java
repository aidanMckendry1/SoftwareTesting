...
public class DataUtilitiesTest {
	...
	public void testCalculateRowTotalFiveRows() {
		...
		assertEquals("Wrong sum returned. It should be 0.0", 0.0, DataUtilities.calculateRowTotal(values2D, 4),0.0000001d);
	}
	...
	public void testCalculateRowTotalNegativeRow() {
		...
		assertEquals("Wrong sum returned. It should be 0.0", 0.0, DataUtilities.calculateRowTotal(values2D, -1),0.0000001d);
	}
